...
- Conducted vulnerability assessments (Greenbone/OpenVAS), enforced RBAC, and hardened AD.  
- Managed **routers, switches, VLANs, firewalls, VPNs, endpoints** across 10+ sites.  
- Systems administration: AD/GPOs, Microsoft 365, Domino, Linux; automated processes with PowerShell, Python, Bash.  
- Key projects: Head Office Infrastructure, Server Room Build, Virtualisation (Hyper-V/XenServer), O365 Migration.  
